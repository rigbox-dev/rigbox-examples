...
// `frontend-api` half of the frontend-plus-api project. Surfaces a tiny
...
// Sibling frontend lives on a different subdomain (frontend-web-<ws> vs
// frontend-api-<ws>) so every request from the browser is cross-origin
